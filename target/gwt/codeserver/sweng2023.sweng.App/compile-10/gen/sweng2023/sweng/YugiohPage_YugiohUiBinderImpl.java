// .ui.xml template last modified: 1698175237909
...
public class YugiohPage_YugiohUiBinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, sweng2023.sweng.YugiohPage>, sweng2023.sweng.YugiohPage.YugiohUiBinder {
  ...
  interface Template extends SafeHtmlTemplates {
    ...
    @Template("<h1>Yugioh Cards</h1> <span id='{0}'></span> <br><br><br> <span id='{1}'></span> <span id='{2}'></span> <br><br> <span id='{3}'></span> <span id='{4}'></span> <span id='{5}'></span> <span id='{6}'></span> <br><br> <span id='{7}'></span> <br><br><br>  <span id='{8}'></span>")
  ...
  public com.google.gwt.user.client.ui.Widget createAndBindUi(final sweng2023.sweng.YugiohPage owner) {
   ...
   */
  class Widgets {
    private final sweng2023.sweng.YugiohPage owner;
    ...
    public Widgets(final sweng2023.sweng.YugiohPage owner) {
      this.owner = owner;
     ...
     */
    private sweng2023.sweng.YugiohPage_YugiohUiBinderImpl_GenBundle get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      return build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay();
    }
    private sweng2023.sweng.YugiohPage_YugiohUiBinderImpl_GenBundle build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      // Creation section.
      final sweng2023.sweng.YugiohPage_YugiohUiBinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (sweng2023.sweng.YugiohPage_YugiohUiBinderImpl_GenBundle) GWT.create(sweng2023.sweng.YugiohPage_YugiohUiBinderImpl_GenBundle.class);
      // Setup section.
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_f_HTMLPanel1() {
      ...
      f_HTMLPanel1.addAndReplaceElement(get_raceFilter(), get_domId4Element().get());
      f_HTMLPanel1.addAndReplaceElement(get_f_Label4(), get_domId5Element().get());
      f_HTMLPanel1.addAndReplaceElement(get_typeFilter(), get_domId6Element().get());
    ...
    /**
     * Getter for raceFilter called 1 times. Type: DEFAULT. Build precedence: 2.
     */
    private com.google.gwt.user.client.ui.ListBox get_raceFilter() {
      return build_raceFilter();
    }
    private com.google.gwt.user.client.ui.ListBox build_raceFilter() {
      // Creation section.
      final com.google.gwt.user.client.ui.ListBox raceFilter = (com.google.gwt.user.client.ui.ListBox) GWT.create(com.google.gwt.user.client.ui.ListBox.class);
      // Setup section.

      this.owner.raceFilter = raceFilter;
    ...
    /**
     * Getter for typeFilter called 1 times. Type: DEFAULT. Build precedence: 2.
     */
    private com.google.gwt.user.client.ui.ListBox get_typeFilter() {
      return build_typeFilter();
    }
    private com.google.gwt.user.client.ui.ListBox build_typeFilter() {
      // Creation section.
      final com.google.gwt.user.client.ui.ListBox typeFilter = (com.google.gwt.user.client.ui.ListBox) GWT.create(com.google.gwt.user.client.ui.ListBox.class);
      // Setup section.

      this.owner.typeFilter = typeFilter;
