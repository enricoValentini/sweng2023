...
function fff_g$(idPanel_0_g$, utente_0_g$){
  mdf_g$();
  var cardButtonsClosing_0_g$, cardButtonsOpening_0_g$, logoutButton_0_g$;
  logoutButton_0_g$ = new L2c_g$('Logout');
  cardButtonsOpening_0_g$ = new N7c_g$("<div style='text-align: center'>");
  cardButtonsClosing_0_g$ = new N7c_g$('<\/div>');
  Ird_g$(idPanel_0_g$).add_4_g$(cardButtonsOpening_0_g$);
  Ird_g$(idPanel_0_g$).add_4_g$(logoutButton_0_g$);
  Ird_g$(idPanel_0_g$).add_4_g$(cardButtonsClosing_0_g$);
}
...
//# sourceMappingURL=http://127.0.0.1:9876/sourcemaps/app/0B533FAE6943F0D915F81A9EC5D58163_sourcemap.json 
//# sourceURL=app-0.js
