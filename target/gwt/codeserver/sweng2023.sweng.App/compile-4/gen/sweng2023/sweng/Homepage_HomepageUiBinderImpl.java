// .ui.xml template last modified: 1698411113699
...
public class Homepage_HomepageUiBinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, sweng2023.sweng.Homepage>, sweng2023.sweng.Homepage.HomepageUiBinder {
  ...
  interface Template extends SafeHtmlTemplates {
    ...
    @Template("<div style='display: block'> <span id='{0}'></span> <span id='{1}'></span> <span id='{2}'></span> <span id='{3}'></span> <span id='{4}'></span> <span id='{5}'></span> </div> <br> <div style='text-align:center'> <span id='{6}'></span> <br> <span id='{7}'></span> <br> <span id='{8}'></span> </div>")
  ...
  class Widgets {
    ...
    SafeHtml template_html10() {
      return template.html10(get_domId0(), get_domId1(), get_domId2(), get_domId3(), get_domId4(), get_domId5(), get_domId6(), get_domId7(), get_domId8());
    }
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_f_HTMLPanel1() {
      ...
      f_HTMLPanel1.addAndReplaceElement(get_posseduteBtn(), get_domId2Element().get());
      f_HTMLPanel1.addAndReplaceElement(get_desiderateBtn(), get_domId3Element().get());
      f_HTMLPanel1.addAndReplaceElement(get_scambiBtn(), get_domId4Element().get());
      f_HTMLPanel1.addAndReplaceElement(get_deckBtn(), get_domId5Element().get());
      f_HTMLPanel1.addAndReplaceElement(get_yugiohBtn(), get_domId6Element().get());
      f_HTMLPanel1.addAndReplaceElement(get_magicBtn(), get_domId7Element().get());
      f_HTMLPanel1.addAndReplaceElement(get_PokemonBtn(), get_domId8Element().get());
    ...
    private com.google.gwt.user.client.ui.Button build_posseduteBtn() {
      ...
      // Setup section.
      posseduteBtn.setHTML(template_html3().asString());
    ...
    private com.google.gwt.user.client.ui.Button build_desiderateBtn() {
      ...
      // Setup section.
      desiderateBtn.setHTML(template_html4().asString());
    ...
    private com.google.gwt.user.client.ui.Button build_scambiBtn() {
      ...
      // Setup section.
      scambiBtn.setHTML(template_html5().asString());
    ...
    private com.google.gwt.user.client.ui.Button build_deckBtn() {
      ...
      // Setup section.
      deckBtn.setHTML(template_html6().asString());
    ...
    private com.google.gwt.user.client.ui.Button build_yugiohBtn() {
      ...
      // Setup section.
      yugiohBtn.setHTML(template_html7().asString());
    ...
    private com.google.gwt.user.client.ui.Button build_magicBtn() {
      ...
      // Setup section.
      magicBtn.setHTML(template_html8().asString());
    ...
    private com.google.gwt.user.client.ui.Button build_PokemonBtn() {
      ...
      // Setup section.
      PokemonBtn.setHTML(template_html9().asString());
