// .ui.xml template last modified: 1698269404311
...
public class PokemonPage_PokemonUiBinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, sweng2023.sweng.PokemonPage>, sweng2023.sweng.PokemonPage.PokemonUiBinder {
  ...
  interface Template extends SafeHtmlTemplates {
    ...
    @Template("<h1>Pokemon Cards</h1> <span id='{0}'></span> <br><br><br> <span id='{1}'></span> <span id='{2}'></span> <br><br> <span id='{3}'></span> <span id='{4}'></span> <span id='{5}'></span> <span id='{6}'></span> <br><br> <span id='{7}'></span> <br><br><br>  <span id='{8}'></span>")
  ...
  public com.google.gwt.user.client.ui.Widget createAndBindUi(final sweng2023.sweng.PokemonPage owner) {
   ...
   */
  class Widgets {
    private final sweng2023.sweng.PokemonPage owner;
    ...
    public Widgets(final sweng2023.sweng.PokemonPage owner) {
      this.owner = owner;
     ...
     */
    private sweng2023.sweng.PokemonPage_PokemonUiBinderImpl_GenBundle get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      return build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay();
    }
    private sweng2023.sweng.PokemonPage_PokemonUiBinderImpl_GenBundle build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      // Creation section.
      final sweng2023.sweng.PokemonPage_PokemonUiBinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (sweng2023.sweng.PokemonPage_PokemonUiBinderImpl_GenBundle) GWT.create(sweng2023.sweng.PokemonPage_PokemonUiBinderImpl_GenBundle.class);
      // Setup section.
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_f_HTMLPanel1() {
      ...
      f_HTMLPanel1.addAndReplaceElement(get_nameFilter(), get_domId2Element().get());
      f_HTMLPanel1.addAndReplaceElement(get_f_Label3(), get_domId3Element().get());
      f_HTMLPanel1.addAndReplaceElement(get_typesFilter(), get_domId4Element().get());
      f_HTMLPanel1.addAndReplaceElement(get_f_Label4(), get_domId5Element().get());
      f_HTMLPanel1.addAndReplaceElement(get_rarityFilter(), get_domId6Element().get());
      f_HTMLPanel1.addAndReplaceElement(get_searchButton(), get_domId7Element().get());
      f_HTMLPanel1.addAndReplaceElement(get_cardTable(), get_domId8Element().get());
    ...
    /**
     * Getter for nameFilter called 1 times. Type: DEFAULT. Build precedence: 2.
     */
    private com.google.gwt.user.client.ui.TextBox get_nameFilter() {
      return build_nameFilter();
    }
    private com.google.gwt.user.client.ui.TextBox build_nameFilter() {
      // Creation section.
      final com.google.gwt.user.client.ui.TextBox nameFilter = (com.google.gwt.user.client.ui.TextBox) GWT.create(com.google.gwt.user.client.ui.TextBox.class);
      // Setup section.

      this.owner.nameFilter = nameFilter;
    ...
    /**
     * Getter for typesFilter called 1 times. Type: DEFAULT. Build precedence: 2.
     */
    private com.google.gwt.user.client.ui.ListBox get_typesFilter() {
      return build_typesFilter();
    }
    private com.google.gwt.user.client.ui.ListBox build_typesFilter() {
      // Creation section.
      final com.google.gwt.user.client.ui.ListBox typesFilter = (com.google.gwt.user.client.ui.ListBox) GWT.create(com.google.gwt.user.client.ui.ListBox.class);
      // Setup section.

      this.owner.typesFilter = typesFilter;
    ...
    private com.google.gwt.user.client.ui.Label build_f_Label4() {
      ...
      // Setup section.
      f_Label4.setText("Rarity Filter:");
    ...
    /**
     * Getter for rarityFilter called 1 times. Type: DEFAULT. Build precedence: 2.
     */
    private com.google.gwt.user.client.ui.ListBox get_rarityFilter() {
      return build_rarityFilter();
    }
    private com.google.gwt.user.client.ui.ListBox build_rarityFilter() {
      // Creation section.
      final com.google.gwt.user.client.ui.ListBox rarityFilter = (com.google.gwt.user.client.ui.ListBox) GWT.create(com.google.gwt.user.client.ui.ListBox.class);
      // Setup section.

      this.owner.rarityFilter = rarityFilter;
    ...
    /**
     * Getter for searchButton called 1 times. Type: DEFAULT. Build precedence: 2.
     */
    private com.google.gwt.user.client.ui.Button get_searchButton() {
      return build_searchButton();
    }
    private com.google.gwt.user.client.ui.Button build_searchButton() {
      // Creation section.
      final com.google.gwt.user.client.ui.Button searchButton = (com.google.gwt.user.client.ui.Button) GWT.create(com.google.gwt.user.client.ui.Button.class);
      // Setup section.
      searchButton.setHTML(template_html2().asString());
      searchButton.addClickHandler(handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames2);
