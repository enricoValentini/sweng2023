// .ui.xml template last modified: 1698252528980
...
public class CreaDeckPage_CreaDeckPageUiBinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, sweng2023.sweng.CreaDeckPage>, sweng2023.sweng.CreaDeckPage.CreaDeckPageUiBinder {
  ...
  interface Template extends SafeHtmlTemplates {
    ...
    @Template("<h1>Crea un deck</h1> <span id='{0}'></span> <span id='{1}'></span> <span id='{2}'></span> <span id='{3}'></span> <span id='{4}'></span>")
  ...
  class Widgets {
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_f_HTMLPanel1() {
      ...
      f_HTMLPanel1.addAndReplaceElement(get_cardTable(), get_domId4Element().get());
