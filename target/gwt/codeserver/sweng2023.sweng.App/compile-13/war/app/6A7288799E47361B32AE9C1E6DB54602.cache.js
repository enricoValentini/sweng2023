...
function kef_g$(streamReader_0_g$, instance_0_g$){
  hef_g$();
}

function oef_g$(streamReader_0_g$){
  hef_g$();
  return QJd_g$(streamReader_0_g$.readBoolean_0_g$());
}

function ref_g$(streamWriter_0_g$, instance_0_g$){
  hef_g$();
  streamWriter_0_g$.writeBoolean_0_g$(wJd_g$(instance_0_g$));
}

Fxc_g$(2085, 1105, {1105:1, 2085:1, 1:1}, jef_g$);
_.$init_1427_g$ = function ief_g$(){
  hef_g$();
}
;
_.deserializeInstance_0_g$ = function mef_g$(streamReader_0_g$, instance_0_g$){
  this.deserializeInstance_2_g$(streamReader_0_g$, cvc_g$(instance_0_g$));
}
;
_.instantiateInstance_0_g$ = function qef_g$(streamReader_0_g$){
  return this.instantiateInstance_2_g$(streamReader_0_g$);
}
;
_.serializeInstance_0_g$ = function tef_g$(streamWriter_0_g$, instance_0_g$){
  this.serializeInstance_2_g$(streamWriter_0_g$, cvc_g$(instance_0_g$));
}
;
_.deserializeInstance_2_g$ = function lef_g$(streamReader_0_g$, instance_0_g$){
  kef_g$(streamReader_0_g$, instance_0_g$);
}
;
_.hasCustomInstantiateInstance_0_g$ = function nef_g$(){
  return true;
}
;
_.instantiateInstance_2_g$ = function pef_g$(streamReader_0_g$){
  return oef_g$(streamReader_0_g$);
}
;
_.serializeInstance_2_g$ = function sef_g$(streamWriter_0_g$, instance_0_g$){
  ref_g$(streamWriter_0_g$, instance_0_g$);
}
;
var Lcom_google_gwt_user_client_rpc_core_java_lang_Boolean_1CustomFieldSerializer_2_classLit_0_g$ = zMd_g$('com.google.gwt.user.client.rpc.core.java.lang', 'Boolean_CustomFieldSerializer', 2085, Lcom_google_gwt_user_client_rpc_CustomFieldSerializer_2_classLit_0_g$);
function DVc_g$(){
  DVc_g$ = Object;
  a_g$();
}
...
_.onModuleLoad_0_g$ = function w9e_g$(){
  var buttonsSpace_0_g$, errorLabel_0_g$, errorLabelSpace_0_g$, labelsSpace_0_g$, loginButton_0_g$, passwordField_0_g$, registerButton_0_g$, usernameField_0_g$;
  ...
  labelsSpace_0_g$ = new N7c_g$('<br>');
  buttonsSpace_0_g$ = new N7c_g$('<br>');
  errorLabelSpace_0_g$ = new N7c_g$('<br>');
  Ird_g$('login').add_4_g$(usernameField_0_g$);
  Ird_g$('login').add_4_g$(labelsSpace_0_g$);
  Ird_g$('login').add_4_g$(passwordField_0_g$);
  Ird_g$('login').add_4_g$(buttonsSpace_0_g$);
  Ird_g$('login').add_4_g$(loginButton_0_g$);
  Ird_g$('login').add_4_g$(registerButton_0_g$);
  Ird_g$('login').add_4_g$(errorLabelSpace_0_g$);
  Ird_g$('login').add_4_g$(errorLabel_0_g$);
  registerButton_0_g$.addClickHandler_0_g$(new z9e_g$(this));
  loginButton_0_g$.addClickHandler_0_g$(new Aef_g$(this, usernameField_0_g$, passwordField_0_g$, errorLabel_0_g$));
}
;
...
function Aef_g$(this$0_0_g$, val$usernameField_0_g$, val$passwordField_0_g$, val$errorLabel_0_g$){
  yef_g$();
  this.this$01_82_g$ = this$0_0_g$;
  this.val$usernameField2_0_g$ = val$usernameField_0_g$;
  this.val$passwordField3_0_g$ = val$passwordField_0_g$;
  this.val$errorLabel4_0_g$ = val$errorLabel_0_g$;
  i_g$.call(this);
  this.$init_1428_g$();
}

Fxc_g$(2086, 1, {745:1, 879:1, 1:1, 2086:1}, Aef_g$);
_.$init_1428_g$ = function zef_g$(){
  yef_g$();
}
;
_.onClick_0_g$ = function Bef_g$(event_0_g$){
  var password_0_g$, username_0_g$;
  username_0_g$ = this.val$usernameField2_0_g$.getText_0_g$();
  password_0_g$ = this.val$passwordField3_0_g$.getText_0_g$();
  this.this$01_82_g$.greetingService_0_g$.login_0_g$(username_0_g$, password_0_g$, new Eef_g$(this, this.val$errorLabel4_0_g$, username_0_g$, password_0_g$));
}
;
var Lsweng2023_sweng_App$2_2_classLit_0_g$ = zMd_g$('sweng2023.sweng', 'App/2', 2086, Ljava_lang_Object_2_classLit_0_g$);
function Cef_g$(){
  Cef_g$ = Object;
  a_g$();
}

function Eef_g$(this$1_0_g$, val$errorLabel_0_g$, val$username_0_g$, val$password_0_g$){
  Cef_g$();
  this.this$11_10_g$ = this$1_0_g$;
  this.val$errorLabel2_3_g$ = val$errorLabel_0_g$;
  this.val$username3_0_g$ = val$username_0_g$;
  this.val$password4_0_g$ = val$password_0_g$;
  i_g$.call(this);
  this.$init_1429_g$();
}

Fxc_g$(2087, 1, {1104:1, 1:1, 2087:1}, Eef_g$);
_.$init_1429_g$ = function Def_g$(){
  Cef_g$();
}
;
_.onSuccess_0_g$ = function Hef_g$(result_0_g$){
  this.onSuccess_5_g$(cvc_g$(result_0_g$));
}
;
_.onFailure_1_g$ = function Fef_g$(caught_0_g$){
  this.val$errorLabel2_3_g$.setText_0_g$('error');
}
;
_.onSuccess_5_g$ = function Gef_g$(result_0_g$){
  var utente_0_g$;
  if (!wJd_g$(result_0_g$)) {
    this.val$errorLabel2_3_g$.setText_0_g$('Email o password errate!');
  }
   else {
    utente_0_g$ = new iff_g$(this.val$username3_0_g$, this.val$password4_0_g$);
    kdf_g$('login');
    fff_g$('main-menu', utente_0_g$);
  }
}
;
var Lsweng2023_sweng_App$2$1_2_classLit_0_g$ = zMd_g$('sweng2023.sweng', 'App/2/1', 2087, Ljava_lang_Object_2_classLit_0_g$);
function hdf_g$(){
  hdf_g$ = Object;
  a_g$();
}
...
function kdf_g$(idPanel_0_g$){
  hdf_g$();
  Ird_g$(idPanel_0_g$).clear_0_g$();
}

Fxc_g$(2079, 1, {1:1, 2079:1}, jdf_g$);
_.$init_1421_g$ = function idf_g$(){
  hdf_g$();
}
;
var Lsweng2023_sweng_Cleaner_2_classLit_0_g$ = zMd_g$('sweng2023.sweng', 'Cleaner', 2079, Ljava_lang_Object_2_classLit_0_g$);
function R9e_g$(){
  R9e_g$ = Object;
  a_g$();
}
...
function qaf_g$(){
  oaf_g$();
  nYc_g$.call(this, OA_g$(), 'greet', kvc_g$('09FCDB7BA4529773D0EEA775E46EC74C'), SERIALIZER_0_g$);
  this.$init_1419_g$();
}
...
;
_.login_0_g$ = function Kef_g$(username_0_g$, password_0_g$, callback_0_g$){
  var ex_0_g$, helper_0_g$, streamWriter_0_g$;
  helper_0_g$ = new PYc_g$(this, 'GreetingService_Proxy', 'login');
  try {
    streamWriter_0_g$ = helper_0_g$.start_5_g$(kvc_g$('sweng2023.sweng.GreetingService'), 2);
    streamWriter_0_g$.writeString_0_g$('java.lang.String/2004016611');
    streamWriter_0_g$.writeString_0_g$('java.lang.String/2004016611');
...
;
_.register_0_g$ = function cef_g$(username_0_g$, password_0_g$, callback_0_g$){
  var ex_0_g$, helper_0_g$, streamWriter_0_g$;
  helper_0_g$ = new PYc_g$(this, 'GreetingService_Proxy', 'register');
  try {
    streamWriter_0_g$ = helper_0_g$.start_5_g$(kvc_g$('sweng2023.sweng.GreetingService'), 2);
    streamWriter_0_g$.writeString_0_g$('java.lang.String/2004016611');
    streamWriter_0_g$.writeString_0_g$('java.lang.String/2004016611');
    streamWriter_0_g$.writeString_0_g$(username_0_g$);
    streamWriter_0_g$.writeString_0_g$(password_0_g$);
    helper_0_g$.finish_2_g$(callback_0_g$, (ZYc_g$() , STRING_0_g$));
  }
   catch ($e0_0_g$) {
    $e0_0_g$ = owc_g$($e0_0_g$);
    if (pvc_g$($e0_0_g$, 1117)) {
...
function yaf_g$(){
  ...
  result_0_g$['java.lang.Boolean/476441737'] = [oef_g$, kef_g$];
...
function zaf_g$(){
  ...
  result_0_g$[X7e_g$(Ljava_lang_Boolean_2_classLit_0_g$)] = 'java.lang.Boolean/476441737';
...
function mdf_g$(){
  mdf_g$ = Object;
  a_g$();
  greetingService_1_g$ = _uc_g$(new qaf_g$, 2076);
}
...
function Vdf_g$(idPanel_0_g$){
  ...
  buttonsSpace_0_g$ = new N7c_g$('<br>');
  errorLabelSpace_0_g$ = new N7c_g$('<br>');
  Ird_g$(idPanel_0_g$).add_4_g$(usernameField_0_g$);
  Ird_g$(idPanel_0_g$).add_4_g$(labelsSpace_0_g$);
  Ird_g$(idPanel_0_g$).add_4_g$(passwordField_0_g$);
  Ird_g$(idPanel_0_g$).add_4_g$(buttonsSpace_0_g$);
  Ird_g$(idPanel_0_g$).add_4_g$(loginButton_0_g$);
  Ird_g$(idPanel_0_g$).add_4_g$(registerButton_0_g$);
  Ird_g$(idPanel_0_g$).add_4_g$(errorLabelSpace_0_g$);
  Ird_g$(idPanel_0_g$).add_4_g$(errorLabel_0_g$);
  registerButton_0_g$.addClickHandler_0_g$(new aef_g$(idPanel_0_g$));
  loginButton_0_g$.addClickHandler_0_g$(new Pef_g$(usernameField_0_g$, passwordField_0_g$, errorLabel_0_g$));
}

function fff_g$(idPanel_0_g$, utente_0_g$){
  mdf_g$();
  var logoutButton_0_g$, magic_0_g$, pokemon_0_g$, space1_0_g$, space2_0_g$, space3_0_g$, yugi_0_g$;
  logoutButton_0_g$ = new L2c_g$('Logout');
  yugi_0_g$ = new L2c_g$('Yu-gi-oh');
  pokemon_0_g$ = new L2c_g$('Pokemon');
  magic_0_g$ = new L2c_g$('Magic');
  space1_0_g$ = new N7c_g$('<br><br>');
  space2_0_g$ = new N7c_g$('<br>');
  space3_0_g$ = new N7c_g$('<br>');
  yugi_0_g$.addStyleName_0_g$('sendButton');
  Ird_g$(idPanel_0_g$).add_4_g$(logoutButton_0_g$);
  Ird_g$(idPanel_0_g$).add_4_g$(space1_0_g$);
  Ird_g$(idPanel_0_g$).add_4_g$(yugi_0_g$);
  Ird_g$(idPanel_0_g$).add_4_g$(space2_0_g$);
  Ird_g$(idPanel_0_g$).add_4_g$(pokemon_0_g$);
  Ird_g$(idPanel_0_g$).add_4_g$(space3_0_g$);
  Ird_g$(idPanel_0_g$).add_4_g$(magic_0_g$);
  logoutButton_0_g$.addClickHandler_0_g$(new mff_g$(utente_0_g$, idPanel_0_g$));
}

function pdf_g$(idPanel_0_g$){
  mdf_g$();
  var backLoginButton_0_g$, buttonSpace_0_g$, errorLabel_0_g$, errorLabelSpace_0_g$, labelsSpace_0_g$, passwordField_0_g$, registerButton_0_g$, usernameField_0_g$;
  registerButton_0_g$ = new L2c_g$('Registrati');
  backLoginButton_0_g$ = new L2c_g$('Torna al login');
  usernameField_0_g$ = new cyd_g$;
  passwordField_0_g$ = new cyd_g$;
  errorLabel_0_g$ = new R6c_g$;
  labelsSpace_0_g$ = new N7c_g$('<br>');
  buttonSpace_0_g$ = new N7c_g$('<br>');
  errorLabelSpace_0_g$ = new N7c_g$('<br>');
  Ird_g$(idPanel_0_g$).add_4_g$(usernameField_0_g$);
  Ird_g$(idPanel_0_g$).add_4_g$(labelsSpace_0_g$);
  Ird_g$(idPanel_0_g$).add_4_g$(passwordField_0_g$);
  Ird_g$(idPanel_0_g$).add_4_g$(buttonSpace_0_g$);
  Ird_g$(idPanel_0_g$).add_4_g$(registerButton_0_g$);
  Ird_g$(idPanel_0_g$).add_4_g$(backLoginButton_0_g$);
  Ird_g$(idPanel_0_g$).add_4_g$(errorLabelSpace_0_g$);
  Ird_g$(idPanel_0_g$).add_4_g$(errorLabel_0_g$);
  registerButton_0_g$.addClickHandler_0_g$(new Ndf_g$(usernameField_0_g$, passwordField_0_g$, errorLabel_0_g$));
  backLoginButton_0_g$.addClickHandler_0_g$(new Ydf_g$(idPanel_0_g$));
}

Fxc_g$(2080, 1, {1:1, 2080:1}, odf_g$);
_.$init_1422_g$ = function ndf_g$(){
  mdf_g$();
}
;
var greetingService_1_g$;
var Lsweng2023_sweng_Loader_2_classLit_0_g$ = zMd_g$('sweng2023.sweng', 'Loader', 2080, Ljava_lang_Object_2_classLit_0_g$);
function Ldf_g$(){
  Ldf_g$ = Object;
  a_g$();
}

function Ndf_g$(val$usernameField_0_g$, val$passwordField_0_g$, val$errorLabel_0_g$){
  Ldf_g$();
  this.val$usernameField1_0_g$ = val$usernameField_0_g$;
  this.val$passwordField2_0_g$ = val$passwordField_0_g$;
  this.val$errorLabel3_0_g$ = val$errorLabel_0_g$;
  i_g$.call(this);
  this.$init_1423_g$();
}

Fxc_g$(2081, 1, {745:1, 879:1, 1:1, 2081:1}, Ndf_g$);
_.$init_1423_g$ = function Mdf_g$(){
  Ldf_g$();
}
;
_.onClick_0_g$ = function Odf_g$(event_0_g$){
  var password_0_g$, username_0_g$;
  username_0_g$ = this.val$usernameField1_0_g$.getText_0_g$();
  password_0_g$ = this.val$passwordField2_0_g$.getText_0_g$();
  (mdf_g$() , greetingService_1_g$).register_0_g$(username_0_g$, password_0_g$, new Rdf_g$(this, this.val$errorLabel3_0_g$));
}
;
var Lsweng2023_sweng_Loader$1_2_classLit_0_g$ = zMd_g$('sweng2023.sweng', 'Loader/1', 2081, Ljava_lang_Object_2_classLit_0_g$);
function Pdf_g$(){
  Pdf_g$ = Object;
  a_g$();
}

function Rdf_g$(this$1_0_g$, val$errorLabel_0_g$){
  Pdf_g$();
  this.this$11_9_g$ = this$1_0_g$;
  this.val$errorLabel2_2_g$ = val$errorLabel_0_g$;
  i_g$.call(this);
  this.$init_1424_g$();
}

Fxc_g$(2082, 1, {1104:1, 1:1, 2082:1}, Rdf_g$);
_.$init_1424_g$ = function Qdf_g$(){
  Pdf_g$();
}
;
_.onSuccess_0_g$ = function Tdf_g$(result_0_g$){
  this.onSuccess_4_g$(kvc_g$(result_0_g$));
}
;
_.onFailure_1_g$ = function Sdf_g$(caught_0_g$){
  this.val$errorLabel2_2_g$.setText_0_g$('error');
}
;
_.onSuccess_4_g$ = function Udf_g$(result_0_g$){
  this.val$errorLabel2_2_g$.setText_0_g$(result_0_g$);
}
;
var Lsweng2023_sweng_Loader$1$1_2_classLit_0_g$ = zMd_g$('sweng2023.sweng', 'Loader/1/1', 2082, Ljava_lang_Object_2_classLit_0_g$);
function Wdf_g$(){
  Wdf_g$ = Object;
  a_g$();
}

function Ydf_g$(val$idPanel_0_g$){
  Wdf_g$();
  this.val$idPanel1_0_g$ = val$idPanel_0_g$;
  i_g$.call(this);
  this.$init_1425_g$();
}

Fxc_g$(2083, 1, {745:1, 879:1, 1:1, 2083:1}, Ydf_g$);
_.$init_1425_g$ = function Xdf_g$(){
  Wdf_g$();
}
;
_.onClick_0_g$ = function Zdf_g$(event_0_g$){
  kdf_g$(this.val$idPanel1_0_g$);
  Vdf_g$('login');
}
;
var Lsweng2023_sweng_Loader$2_2_classLit_0_g$ = zMd_g$('sweng2023.sweng', 'Loader/2', 2083, Ljava_lang_Object_2_classLit_0_g$);
function $df_g$(){
  $df_g$ = Object;
  a_g$();
}

function aef_g$(val$idPanel_0_g$){
  $df_g$();
  this.val$idPanel1_1_g$ = val$idPanel_0_g$;
  i_g$.call(this);
  this.$init_1426_g$();
}

Fxc_g$(2084, 1, {745:1, 879:1, 1:1, 2084:1}, aef_g$);
_.$init_1426_g$ = function _df_g$(){
  $df_g$();
}
;
_.onClick_0_g$ = function bef_g$(event_0_g$){
  kdf_g$(this.val$idPanel1_1_g$);
  pdf_g$('register');
}
;
var Lsweng2023_sweng_Loader$3_2_classLit_0_g$ = zMd_g$('sweng2023.sweng', 'Loader/3', 2084, Ljava_lang_Object_2_classLit_0_g$);
function Nef_g$(){
  Nef_g$ = Object;
  a_g$();
}

function Pef_g$(val$usernameField_0_g$, val$passwordField_0_g$, val$errorLabel_0_g$){
  Nef_g$();
  this.val$usernameField1_1_g$ = val$usernameField_0_g$;
  this.val$passwordField2_1_g$ = val$passwordField_0_g$;
  this.val$errorLabel3_1_g$ = val$errorLabel_0_g$;
  i_g$.call(this);
  this.$init_1430_g$();
}

Fxc_g$(2088, 1, {745:1, 879:1, 1:1, 2088:1}, Pef_g$);
_.$init_1430_g$ = function Oef_g$(){
  Nef_g$();
}
;
_.onClick_0_g$ = function Qef_g$(event_0_g$){
  var password_0_g$, username_0_g$;
  username_0_g$ = this.val$usernameField1_1_g$.getText_0_g$();
  password_0_g$ = this.val$passwordField2_1_g$.getText_0_g$();
  (mdf_g$() , greetingService_1_g$).login_0_g$(username_0_g$, password_0_g$, new Tef_g$(this, this.val$errorLabel3_1_g$, username_0_g$, password_0_g$));
}
;
var Lsweng2023_sweng_Loader$4_2_classLit_0_g$ = zMd_g$('sweng2023.sweng', 'Loader/4', 2088, Ljava_lang_Object_2_classLit_0_g$);
function Ref_g$(){
  Ref_g$ = Object;
  a_g$();
}

function Tef_g$(this$1_0_g$, val$errorLabel_0_g$, val$username_0_g$, val$password_0_g$){
  Ref_g$();
  this.this$11_11_g$ = this$1_0_g$;
  this.val$errorLabel2_4_g$ = val$errorLabel_0_g$;
  this.val$username3_1_g$ = val$username_0_g$;
  this.val$password4_1_g$ = val$password_0_g$;
  i_g$.call(this);
  this.$init_1431_g$();
}

Fxc_g$(2089, 1, {1104:1, 1:1, 2089:1}, Tef_g$);
_.$init_1431_g$ = function Sef_g$(){
  Ref_g$();
}
;
_.onSuccess_0_g$ = function Wef_g$(result_0_g$){
  this.onSuccess_5_g$(cvc_g$(result_0_g$));
}
;
_.onFailure_1_g$ = function Uef_g$(caught_0_g$){
  this.val$errorLabel2_4_g$.setText_0_g$('error');
}
;
_.onSuccess_5_g$ = function Vef_g$(result_0_g$){
  var utente_0_g$;
  if (!wJd_g$(result_0_g$)) {
    this.val$errorLabel2_4_g$.setText_0_g$('Email o password errate!');
  }
   else {
    utente_0_g$ = new iff_g$(this.val$username3_1_g$, this.val$password4_1_g$);
    kdf_g$('login');
    fff_g$('main-menu', utente_0_g$);
  }
}
;
var Lsweng2023_sweng_Loader$4$1_2_classLit_0_g$ = zMd_g$('sweng2023.sweng', 'Loader/4/1', 2089, Ljava_lang_Object_2_classLit_0_g$);
function kff_g$(){
  kff_g$ = Object;
  a_g$();
}

function mff_g$(val$utente_0_g$, val$idPanel_0_g$){
  kff_g$();
  this.val$utente1_0_g$ = val$utente_0_g$;
  this.val$idPanel2_0_g$ = val$idPanel_0_g$;
  i_g$.call(this);
  this.$init_1433_g$();
}

Fxc_g$(2091, 1, {745:1, 879:1, 1:1, 2091:1}, mff_g$);
_.$init_1433_g$ = function lff_g$(){
  kff_g$();
}
;
_.onClick_0_g$ = function nff_g$(event_0_g$){
  this.val$utente1_0_g$.destroy_0_g$();
  kdf_g$(this.val$idPanel2_0_g$);
  Vdf_g$('login');
}
;
var Lsweng2023_sweng_Loader$5_2_classLit_0_g$ = zMd_g$('sweng2023.sweng', 'Loader/5', 2091, Ljava_lang_Object_2_classLit_0_g$);
function gff_g$(){
  gff_g$ = Object;
  a_g$();
}

function iff_g$(username_0_g$, password_0_g$){
  gff_g$();
  i_g$.call(this);
  this.$init_1432_g$();
...
Fxc_g$(2090, 1, {1:1, 2090:1}, iff_g$);
_.$init_1432_g$ = function hff_g$(){
  gff_g$();
}
;
_.destroy_0_g$ = function off_g$(){
  this.username_1_g$ = null;
  this.password_2_g$ = null;
}
;
var Lsweng2023_sweng_Utente_2_classLit_0_g$ = zMd_g$('sweng2023.sweng', 'Utente', 2090, Ljava_lang_Object_2_classLit_0_g$);
...
//# sourceMappingURL=http://127.0.0.1:9876/sourcemaps/app/6A7288799E47361B32AE9C1E6DB54602_sourcemap.json 
//# sourceURL=app-0.js
